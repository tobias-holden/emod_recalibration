...
def submit_sim(site=None, nSims=1, characteristic=False, priority=manifest.priority, my_manifest=manifest,
    ...
    platform = Platform("SLURM_LOCAL", job_directory=manifest.job_directory, partition='b1139', time='8:00:00', #With 9 sites x 10 samples, 6:00:00 hours was not enough
                            account='b1139', modules=['singularity'], max_running_jobs=20, mem=3200)
    ...
    submit_scheduled_analyzer(experiment, platform, site, analyzer_script='run_analyzers.py', mem=10000)
